...
export default function Retreats() {
  ...
  const carouselText = {
    ...
    subhead: ["Next retreat: June 27-July 3, 2026", "Next retreat: February 23-March 1, 2025"],
  ...
  const dolphinText = {
    ...
    Button5: {
      ...
      Text1: "Base trip cost: $4200 (including taxes and fees) per person, double occupancy.",
      Text2: "$1000 deposit due upon registration (non-refundable unless the trip doesn't fill. 8 participants minimum).",
      Text3: "Bonuses:",
      Text4: "$200 off EARLY BIRD BONUS if you register before September 1st!",
      Text5: "$100 off to the first 4 registrations OR if you bring a friend.",
      Text6: "Bi-monthly payment plan for first 4 registrations.",
      Text7: "Check out the other bonuses below.",
      Text8: "Register NOW, only 12 spots available.",
      Text9: "",
      Text10: "",
      Text11: "",
      Text12: "",
    ...
    Button6: {
      ...
      Text3: "Learn Animal Communication and deepen your connection with your beloved animals and the dolphins with 2 online group trainings before the retreat if you register by November 2025.",
      Text4: "",
      Text5: "",
      Text6: "",
      Text7: "",
